export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-base flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      {/* Decorative glow bottom — red muted */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[200px] bg-brand-red/5 rounded-full blur-3xl pointer-events-none" />
